...
import GeophysicalParameters.GeophysicalParameters as GeophysicalParameters
import numpy
...
class ProcessEregionNeutralWinds:
    ...
    def __init__(self, configFile):
        ...
        self.io = IOEregionWinds.IOEregionWinds(nuinScaler=self.nuinScaler)
        self.winds = CalculateEregionWinds.CalculateEregionWinds()
    ...
    def run(self,fname_ac, fname_lp):
        ...
        # make a 'lock file'
        lock_location = os.path.join(FullPathOut,oname+'.lock')
        ...
        for itime in range(acDict['UnixTime'].shape[0]):
            ...
            for ibeam in Ibm:
                ...
                outDict['IntegratedJouleHeatingE'][itime,ibeam] = numpy.trapz(outDict['JouleHeatingE'][itime,ibeam,indx],acDict['Altitude'][ibeam,indx])
                ...
                indx = numpy.where(numpy.isfinite(outDict['JouleHeatingTotal'][itime,ibeam,:]) &\
                                    numpy.isfinite(acDict['Altitude'][ibeam,:]) )[0]
                outDict['IntegratedJouleHeatingTotal'][itime,ibeam] = numpy.trapz(outDict['JouleHeatingTotal'][itime,ibeam,indx],acDict['Altitude'][ibeam,indx])
                ...
                indx = numpy.where(numpy.isfinite(outDict['JouleHeatingMechanical'][itime,ibeam,:]) &\
                                    numpy.isfinite(acDict['Altitude'][ibeam,:]) )[0]
                outDict['IntegratedJouleHeatingMechanical'][itime,ibeam] = numpy.trapz(outDict['JouleHeatingMechanical'][itime,ibeam,indx], acDict['Altitude'][ibeam,indx])
            ...
            if len(qvert) != 0:
                ...
                IntegratedJHFull = numpy.trapz(tmpJHFull,FullAltitude*1000.)
                IntegratedPedConductFull = numpy.trapz(tmpPedCondFullAlt,FullAltitude*1000.)
            ...
            outDict['IntegratedMedianJouleHeatingE'][itime] = numpy.trapz(outDict['MedianJouleHeatingE'][itime,:],tmpAltitude)
            outDict['IntegratedMedianJouleHeatingTotal'][itime] = numpy.trapz(outDict['MedianJouleHeatingTotal'][itime,:],tmpAltitude)
            outDict['IntegratedMedianJouleHeatingMechanical'][itime] = numpy.trapz(outDict['MedianJouleHeatingMechanical'][itime,:], tmpAltitude)
            outDict['MedianHallConductance'][itime] = numpy.trapz(outDict['MedianHallConductivity'][itime,:], tmpAltitude)
            outDict['MedianPedersenConductance'][itime] = numpy.trapz(outDict['MedianPedersenConductivity'][itime,:], tmpAltitude)

            outDict['IntegratedMedianJouleHeatingTotal_Thayer'][itime] = numpy.trapz(outDict['MedianJouleHeatingTotal_Thayer'][itime,:],tmpAltitude)
            outDict['IntegratedMedianJouleHeatingMechanical_Thayer'][itime] = numpy.trapz(outDict['MedianJouleHeatingMechanical_Thayer'][itime,:],tmpAltitude)
            outDict['IntegratedMedianEMTransfer_Thayer'][itime] = numpy.trapz(outDict['MedianEMTransfer_Thayer'][itime,:],tmpAltitude)

            outDict['IntegratedMeanJouleHeatingE'][itime] = numpy.trapz(outDict['MeanJouleHeatingE'][itime,:],tmpAltitude)
            outDict['IntegratedMeanJouleHeatingTotal'][itime] = numpy.trapz(outDict['MeanJouleHeatingTotal'][itime,:],tmpAltitude)
            outDict['IntegratedMeanJouleHeatingMechanical'][itime] = numpy.trapz(outDict['MeanJouleHeatingMechanical'][itime,:], tmpAltitude)
            outDict['MeanHallConductance'][itime] = numpy.trapz(outDict['MeanHallConductivity'][itime,:], tmpAltitude)
            outDict['MeanPedersenConductance'][itime] = numpy.trapz(outDict['MeanPedersenConductivity'][itime,:], tmpAltitude)

            outDict['IntegratedMeanJouleHeatingTotal_Thayer'][itime] = numpy.trapz(outDict['MeanJouleHeatingTotal_Thayer'][itime,:],tmpAltitude)
            outDict['IntegratedMeanJouleHeatingMechanical_Thayer'][itime] = numpy.trapz(outDict['MeanJouleHeatingMechanical_Thayer'][itime,:],tmpAltitude)
            outDict['IntegratedMeanEMTransfer_Thayer'][itime] = numpy.trapz(outDict['MeanEMTransfer_Thayer'][itime,:],tmpAltitude)
