...
class ResolveVectorsLat(object):
    ...
    def save_output(self):
        ...
        with tables.open_file(output, mode='w',filters=FILTERS) as outfile:
            ...
            outfile.create_group('/', 'VvelsMagCoords')

            save_carray(outfile, '/VvelsMagCoords/Latitude', self.bin_mlat, {'TITLE':'Magnetic Latitude', 'Size':'Nbins'})
            save_carray(outfile, '/VvelsMagCoords/Longitude', self.bin_mlon, {'TITLE':'Magnetic Longitude', 'Size':'Nbins'})
            save_carray(outfile, '/VvelsMagCoords/Velocity', self.Velocity, {'TITLE':'Plasma Drift Velocity', 'Size':'Nrecords x Nbins x 3 (Ve1, Ve2, Ve3)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsMagCoords/errVelocity', np.sqrt(np.diagonal(self.VelocityCovariance, axis1=-1, axis2=-2)), {'TITLE':'Plasma Drift Velocity Error', 'Size':'Nrecords x Nbins x 3 (errVe1, errVe2, errVe3)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsMagCoords/CovarianceV', self.VelocityCovariance, {'TITLE':'Velocity Covariance Matrix', 'Size':'Nrecords x Nbins x 3 x 3', 'Units':'(m/s)^2'})
            save_carray(outfile, '/VvelsMagCoords/ElectricField', self.ElectricField, {'TITLE':'Convection Electric Field', 'Size':'Nrecords x Nbins x 3 (Ed1, Ed2, Ed3)', 'Units':'V/m'})
            save_carray(outfile, '/VvelsMagCoords/errElectricField', np.sqrt(np.diagonal(self.ElectricFieldCovariance, axis1=-1, axis2=-2)), {'TITLE':'Convection Electric Field Error', 'Size':'Nrecords x Nbins x 3 (errEd1, errEd2, errEd3)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsMagCoords/CovarianceE', self.ElectricFieldCovariance, {'TITLE':'Electric Field Covariance Matrix', 'Size':'Nrecords x Nbins x 3 x 3', 'Units':'(V/m)^2'})



            outfile.create_group('/', 'VvelsGeoCoords')

            save_carray(outfile, '/VvelsGeoCoords/Latitude', self.bin_glat, {'TITLE':'Geographic Latitude', 'Size':'Nalts x Nbins'})
            save_carray(outfile, '/VvelsGeoCoords/Longitude', self.bin_glon, {'TITLE':'Geographic Longitude', 'Size':'Nalts x Nbins'})
            save_carray(outfile, '/VvelsGeoCoords/Altitude', self.bin_galt, {'TITLE':'Geographic Altitude', 'Size':'Nalts x Nbins', 'Units':'km'})
            save_carray(outfile, '/VvelsGeoCoords/Velocity', self.Velocity_gd, {'TITLE':'Plasma Drift Velocity', 'Size':'Nrecords x Nalts x Nbins x 3 (East, North, Up)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsGeoCoords/errVelocity', np.sqrt(np.diagonal(self.VelocityCovariance_gd, axis1=-1, axis2=-2)), {'TITLE':'Plasma Drift Velocity Error', 'Size':'Nrecords x Nbins x 3 (errVe1, errVe2, errVe3)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsGeoCoords/CovarianceV', self.VelocityCovariance_gd, {'TITLE':'Velocity Covariance Matrix', 'Size':'Nrecords x Nalts x Nbins x 3 x 3', 'Units':'(m/s)^2'})
            save_carray(outfile, '/VvelsGeoCoords/Vmag', self.Vgd_mag, {'TITLE':'Velocity Magnitude', 'Size':'Nrecords x Nalts x Nbins', 'Units':'m/s'})
            save_carray(outfile, '/VvelsGeoCoords/errVmag', self.Vgd_mag_err, {'TITLE':'Velocity Magnitude Error', 'Size':'Nrecords x Nalts x Nbins', 'Units':'m/s'})
            save_carray(outfile, '/VvelsGeoCoords/Vdir', self.Vgd_dir, {'TITLE':'Velocity Direction Angle East of North Magnetic Meridian (-e2)', 'Size':'Nrecords x Nalts x Nbins', 'Units':'Degrees'})
            save_carray(outfile, '/VvelsGeoCoords/errVdir', self.Vgd_dir_err, {'TITLE':'Velocity Direction Error', 'Size':'Nrecords x Nalts x Nbins', 'Units':'Degrees'})
            save_carray(outfile, '/VvelsGeoCoords/ElectricField', self.ElectricField_gd, {'TITLE':'Convection Electric Field', 'Size':'Nrecords x Nbins x 3 (East, North, Up)', 'Units':'V/m'})
            save_carray(outfile, '/VvelsGeoCoords/errElectricField', np.sqrt(np.diagonal(self.ElectricFieldCovariance_gd, axis1=-1, axis2=-2)), {'TITLE':'Convection Electric Field Error', 'Size':'Nrecords x Nbins x 3 (errEd1, errEd2, errEd3)', 'Units':'m/s'})
            save_carray(outfile, '/VvelsGeoCoords/CovarianceE', self.ElectricFieldCovariance_gd, {'TITLE':'Electric Field Covariance Matrix', 'Size':'Nrecords x Nbins x 3 x 3', 'Units':'(V/m)^2'})
            save_carray(outfile, '/VvelsGeoCoords/Emag', self.Egd_mag, {'TITLE':'Electric Field Magnitude', 'Size':'Nrecords x Nalts x Nbins', 'Units':'V/m'})
            save_carray(outfile, '/VvelsGeoCoords/errEmag', self.Egd_mag_err, {'TITLE':'Electric Field Magnitude Error', 'Size':'Nrecords x Nalts x Nbins', 'Units':'V/m'})
            save_carray(outfile, '/VvelsGeoCoords/Edir', self.Egd_dir, {'TITLE':'Electric Field Direction Angle East of North Magnetic Meridian (-e2)', 'Size':'Nrecords x Nalts x Nbins', 'Units':'Degrees'})
